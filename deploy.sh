...
[ -z "$ANALYZE_BATCH_SIZE" ] && MISSING="$MISSING ANALYZE_BATCH_SIZE"
[ -z "$ANALYZE_MAX_TOKENS" ] && MISSING="$MISSING ANALYZE_MAX_TOKENS"
[ -z "$PPT_MARKDOWN_MAX_TOKENS" ] && MISSING="$MISSING PPT_MARKDOWN_MAX_TOKENS"
[ -z "$GAMMA_INPUT_MAX_CHARS" ] && MISSING="$MISSING GAMMA_INPUT_MAX_CHARS"
